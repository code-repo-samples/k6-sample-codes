...
//
// IMPORTANT: this file does NOT reuse a session from another spec file -
// Playwright gives every test a fresh, unauthenticated page by default, so
// each test here logs in for itself via the beforeEach below (same as
// login-and-program.spec.js / login-and-realtime-check.spec.js do explicitly).
// ---------------------------------------------------------------
...
// Every test in this file needs to be logged in first - do it once per test
// here rather than repeating it inside each test.step below.
